...
- **AI Marksheet Extraction:** Upload an image of your marksheet, and the application will use the Llama Vision model (`llama-4-scout-17b-16e-instruct`) via Groq to intelligently extract your subjects and obtained marks.
...
- **AI Integration:** Groq API (`meta-llama/llama-4-scout-17b-16e-instruct`) for extremely fast, accurate image-to-text processing.
...
3. **Configure API (If needed):**
   The application communicates directly with the Groq API for the image extraction feature. Ensure you provide a valid API key in the source code or when configured.
